...
const getdashBoardService = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const tickets = yield ticket_model_1.default.find({ deleted_at: null });
        var resultMovie = [];
                ...
                for (let k = 0; k < seats.length; k++) {
                    const filterData = tickets.find((ticket) => {
                        ...
                        return ((_a = ticket === null || ticket === void 0 ? void 0 : ticket.movie_id) === null || _a === void 0 ? void 0 : _a._id.toString()) === ((_b = movie[i]) === null || _b === void 0 ? void 0 : _b._id.toString()) &&
                            ((_c = ticket === null || ticket === void 0 ? void 0 : ticket.cinema_id) === null || _c === void 0 ? void 0 : _c._id.toString()) ===
                                ((_e = (_d = movie[i]) === null || _d === void 0 ? void 0 : _d.cinema_id) === null || _e === void 0 ? void 0 : _e._id.toString()) &&
...
const getTicketByCinemaIdService = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const tickets = yield ticket_model_1.default.find({
            cinema_id: cinema === null || cinema === void 0 ? void 0 : cinema._id,
